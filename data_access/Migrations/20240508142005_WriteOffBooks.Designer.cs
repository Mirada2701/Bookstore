...
namespace data_access.Migrations
{
    ...
    [Migration("20240508142005_WriteOffBooks")]
    partial class WriteOffBooks
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CustomerWriteOffBooks", b =>
                {
                    b.Property<int>("CustomersId")
                        .HasColumnType("int");

                    b.Property<int>("WriteOffBooksId")
                        .HasColumnType("int");

                    b.HasKey("CustomersId", "WriteOffBooksId");

                    b.HasIndex("WriteOffBooksId");

                    b.ToTable("CustomerWriteOffBooks");
                });
            ...
            modelBuilder.Entity("data_access.Entities.WriteOffBooks", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CustomerWriteOffBooks", b =>
                {
                    ...
                    b.HasOne("data_access.Entities.WriteOffBooks", null)
                        .WithMany()
                        .HasForeignKey("WriteOffBooksId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
